                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min Rs.200</a> </li>
                                    ...
                                    <div class="row">
										...
										<form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="images/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
                    ...
                    <div class="row top-footer">
                        ...
                        <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Sumanahalli</a> </li>
                                <li><a href="#">FrazerTown</a> </li>
                                <li><a href="#">Majestic</a> </li>
                                <li><a href="#">Shivajinagar</a> </li>
                                <li><a href="#">BBNagar</a> </li>
                                <li><a href="#">SamayNagar</a> </li>
                                <li><a href="#">Shantinagar</a> </li>
                                <li><a href="#">MGRoad</a> </li>
                                <li><a href="#">GiriNagar</a> </li>
                            </ul>
                        </div>
                    </div>
                    <!-- top footer ends -->
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Head Office</h5>
                                    <p>No.1358, 3rd cross, SunShineValley, MG Road,Bangalore 560079</p>
                                    <h5>Phone: <a href="tel:+08023507939">080 23507939</a></h5> </div>
