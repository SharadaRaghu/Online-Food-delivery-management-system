        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Find restaurants, delivery, and coupons for free</h5>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">The easiest way to get your hands on your favourite food</p>
                </div>
                <div class="row">
									      ...
									      while($r=mysqli_fetch_array($query_res))
										  {
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="images/'.$r['img'].'">
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="images/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
																<!--end:col -->
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min Rs. 200</div>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/food-picky-logo.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Away </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">AirportRoad</a> </li>
                            <li><a href="#">Kumbalgodu</a> </li>
                            <li><a href="#">JPNagar</a> </li>
                            <li><a href="#">PrashanthNagar</a> </li>
                            <li><a href="#">SahakarNagar</a> </li>
                            <li><a href="#">ShivajiNagar</a> </li>
                            <li><a href="#">KamalaNagar</a> </li>
                            <li><a href="#">VasanthNagar</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Head Office</h5>
                            <p>No-1358, 3rd Cross, SunShine Valley, MG Road, Bangalore 560079</p>
                            <h5> <a href="admin.php">Admin</a></h5> </div>
